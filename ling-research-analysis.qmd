...
```{r}
df_compq <- read_rds(here("homework-5-bribeiro33/data", "df_compq.rds"))
df_demo <- read_rds(here("homework-5-bribeiro33/data", "df_demo.rds"))
df_sprt <- read_rds(here("homework-5-bribeiro33/data", "df_sprt.rds"))
```
